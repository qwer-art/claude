...
```bash
/pull_open_code local-study /home/jerett/OpenProject/MyAgent/raw_paper/my-paper.pdf https://github.com/user/repo
```
...
### 第二步：创建目录结构
```bash
mkdir -p /home/jerett/OpenProject/MyAgent/raw_paper/{项目名称}
...
#### 3.2 远程URL处理
- 使用 `wget` 或 `curl` 下载论文
- 保存到 `/home/jerett/OpenProject/MyAgent/raw_paper/{项目名称}/`
...
📄 论文位置：
/home/jerett/OpenProject/MyAgent/raw_paper/{项目名称}/
└── {论文文件名}
  - 文件大小：{大小}
  - 文件类型：PDF
...
💡 下一步建议：
- 使用 /paper-reader 分析论文：/paper-reader /home/jerett/OpenProject/MyAgent/raw_paper/{项目名称}/{论文文件}
